...
mixin _$EstadoFiltro {
 ...
 List<PreguntaFiltro> get preguntas; Map<int, bool> get respuestas;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(preguntas),const DeepCollectionEquality().hash(respuestas));

@override
String toString() {
  return 'EstadoFiltro(preguntas: $preguntas, respuestas: $respuestas)';
}
...
@useResult
$Res call({
 List<PreguntaFiltro> preguntas, Map<int, bool> respuestas
});
...
/// Create a copy of EstadoFiltro
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? preguntas = null,Object? respuestas = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<PreguntaFiltro> preguntas,  Map<int, bool> respuestas)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EstadoFiltro() when $default != null:
return $default(_that.preguntas,_that.respuestas);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<PreguntaFiltro> preguntas,  Map<int, bool> respuestas)  $default,) {final _that = this;
switch (_that) {
case _EstadoFiltro():
return $default(_that.preguntas,_that.respuestas);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<PreguntaFiltro> preguntas,  Map<int, bool> respuestas)?  $default,) {final _that = this;
switch (_that) {
case _EstadoFiltro() when $default != null:
return $default(_that.preguntas,_that.respuestas);case _:
  return null;
...
class _EstadoFiltro extends EstadoFiltro {
  const _EstadoFiltro({required final  List<PreguntaFiltro> preguntas, required final  Map<int, bool> respuestas}): _preguntas = preguntas,_respuestas = respuestas,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EstadoFiltro&&const DeepCollectionEquality().equals(other._preguntas, _preguntas)&&const DeepCollectionEquality().equals(other._respuestas, _respuestas));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_preguntas),const DeepCollectionEquality().hash(_respuestas));
...
/// Create a copy of EstadoFiltro
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? preguntas = null,Object? respuestas = null,}) {
